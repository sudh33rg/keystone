...
export function DevelopmentStage({ bridge, workflowId, onWorkflowChange }: { bridge: HostBridge; workflowId: string; onWorkflowChange?: (workflow: CanonicalWorkflow) => void }): React.JSX.Element {
  ...
  return <section className="development-workspace" aria-label="Development workspace">
    ...
    <section className="development-section" aria-labelledby="development-prompt"><header><div><span className="eyebrow">4</span><h2 id="development-prompt">Prompt Preparation</h2></div><span>{state.promptPreparation?.status ?? "not prepared"}</span></header>
    ...
    <section className="development-section" aria-labelledby="development-result"><header><div><span className="eyebrow">5</span><h2 id="development-result">Development Result</h2></div><span>{state.result?.reviewStatus ?? "not recorded"}</span></header>
    ...
    <section className="development-section" aria-labelledby="development-changes"><header><div><span className="eyebrow">6</span><h2 id="development-changes">Changed Files</h2></div><span>{state.changeDetection.available ? `${state.changeDetection.changes.length} detected` : "unavailable"}</span></header>
    ...
    <section className="development-section completion-section" aria-labelledby="development-completion"><header><div><span className="eyebrow">7</span><h2 id="development-completion">Completion</h2></div><span>{state.workItem.status === "completed" ? "completed" : state.completion.allowed ? "ready" : "gated"}</span></header>
