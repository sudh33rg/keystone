...
const WEBVIEW_COMMAND_TYPES = new Set<string>([
  ...
  'RECORD_CONTEXT_FEEDBACK', 'CANCEL_INGESTION', 'CANCEL_ANALYSIS', 'ANALYZE_INTENT', 'RUN_VALIDATION',
  ...
  'CREATE_SDLC_PLAN', 'SDLC_TRANSITION', 'APPROVE_SPECIFICATION', 'QUERY_INTELLIGENCE', 'RECORD_DECISION',
