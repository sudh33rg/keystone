...
export class ConfigurationService {
  read(): KeystoneConfiguration {
    ...
    return {
      ...
      workflow: {
        defaultMode: enumValue(workflow.get("defaultMode", "guided"), ["quick", "guided", "spec-driven"], "guided"),
      ...
      logging: {
        level: enumValue(logging.get("level", "info"), ["debug", "info", "warning", "error"], "info")
      }
    };
  }
