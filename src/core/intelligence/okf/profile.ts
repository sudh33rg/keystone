...
import {
  ...
  type KeystoneRelationshipKind
} from "./types";

export interface RelationshipConstraint {
  readonly sources: readonly KeystoneKnowledgeKind[];
  readonly targets: readonly KeystoneKnowledgeKind[];
}
export interface KeystoneOkfProfileDefinition {
  readonly id: typeof KEYSTONE_OKF_PROFILE_ID;
  readonly version: typeof KEYSTONE_OKF_PROFILE_VERSION;
  readonly title: string;
  readonly knowledgeKinds: readonly KeystoneKnowledgeKind[];
  readonly relationshipKinds: readonly KeystoneRelationshipKind[];
  readonly requiredUnitFields: readonly string[];
  readonly requiredRelationshipFields: readonly string[];
  readonly requiredObservationFields: readonly string[];
  readonly relationshipConstraints: Readonly<
    Partial<Record<KeystoneRelationshipKind, RelationshipConstraint>>
  >;
}
const kinds: readonly KeystoneKnowledgeKind[] = [
  "repository",
  "workspace",
  "file",
  "module",
...
export const KEYSTONE_OKF_PROFILE: KeystoneOkfProfileDefinition = Object.freeze({
  id: KEYSTONE_OKF_PROFILE_ID,
  version: KEYSTONE_OKF_PROFILE_VERSION,
  title: "Keystone Repository Intelligence OKF Profile",
...
export const KEYSTONE_OKF_PROFILE_DIGEST = createHash("sha256")
  .update(JSON.stringify(KEYSTONE_OKF_PROFILE))
  .digest("hex");
