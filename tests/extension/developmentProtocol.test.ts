...
describe("Development protocol", () => {
  it.each([
    ...
    ["development.context.build", { correlationId: crypto.randomUUID(), workflowId: crypto.randomUUID(), workItemId: crypto.randomUUID(), budgetTokens: 12_000, pinnedItemIds: [] }],
    ["development.context.changeBudget", { correlationId: crypto.randomUUID(), workflowId: crypto.randomUUID(), workItemId: crypto.randomUUID(), packageId: crypto.randomUUID(), revision: 1, budgetTokens: 8_000, pinnedItemIds: [] }],
    ["development.context.approve", { correlationId: crypto.randomUUID(), workflowId: crypto.randomUUID(), workItemId: crypto.randomUUID(), packageId: crypto.randomUUID(), revision: 1, fingerprint: "a".repeat(64) }],
    ["development.context.pin", { correlationId: crypto.randomUUID(), workflowId: crypto.randomUUID(), workItemId: crypto.randomUUID(), packageId: crypto.randomUUID(), revision: 1, itemId: "scope:a", pinned: true }],
    ["development.context.remove", { correlationId: crypto.randomUUID(), workflowId: crypto.randomUUID(), workItemId: crypto.randomUUID(), packageId: crypto.randomUUID(), revision: 1, itemId: "scope:a", overrideRequired: true }],
    ["development.context.restore", { correlationId: crypto.randomUUID(), workflowId: crypto.randomUUID(), workItemId: crypto.randomUUID(), packageId: crypto.randomUUID(), revision: 1, itemId: "scope:a" }],
