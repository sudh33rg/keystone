...
describe("OrchestrationWorkspace", () => {
  it("renders the focused workspace without fabricating an active workflow", async () => {
    const request = vi.fn((type: string) => Promise.resolve(type === "orchestration/definitions" || type === "orchestration/policies" || type === "orchestration/list" || type === "workflow/list" ? [] : undefined));
