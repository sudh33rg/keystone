...
function queryResult(): IntelligenceQueryResult { return { queryId: "123e4567-e89b-42d3-a456-426614174000", operation: "DEPENDENCIES", generation: 3, repositoryState: { repositoryId: "repository:test", branch: "main", headCommit: "head", generation: 3 }, executionTimeMs: 2.5, resolvedSeeds: [{ selector: { value: "OrderService.create", kind: "name" }, selected: { id: "entity:service", type: "keystone.core.Method", name: "create", qualifiedName: "OrderService.create", relativePath: "service.ts", confidence: 1, score: 1000, reasons: ["exact qualified name"] }, candidates: [], ambiguous: false, requiresSelection: false, reasons: ["exact qualified name"] }], plan: { operation: "DEPENDENCIES", resolvedSeedIds: ["entity:service"], ambiguousCandidateIds: [], indexesSelected: ["entity-scan", "outgoing-adjacency", "relationship-type"], relationshipFamilies: ["keystone.core.CALLS"], traversalDirection: "outgoing", maximumDepth: 3, confidenceThreshold: 0, capabilityThresholds: ["deep", "semantic", "structural", "metadata-only", "unsupported"], cpgRequired: false, resultLimits: { results: 25, nodes: 100, edges: 300, paths: 5, depth: 3, evidence: 30, timeBudgetMs: 1000 }, evidenceRequired: true, timeBudgetMs: 1000 }, data: { kind: "dependencies", items: [{ id: "entity:repo", type: "keystone.core.Method", name: "save", qualifiedName: "OrderRepository.save", relativePath: "repo.ts", score: 900, confidence: 1, classification: "exact", rankingReasons: ["graph distance 1"] }], nodes: [], relationships: [], paths: [], sections: {}, metrics: {} }, evidence: [], diagnostics: [], explanation: { parsedAs: "DEPENDENCIES", parserRule: "dependencies", indexesUsed: ["outgoing"], relationshipFamilies: ["keystone.core.CALLS"], confidenceThreshold: 0, rankingRules: ["exactName=900"], truncationReasons: [], capabilityBoundaries: [], steps: ["Executed dependencies against immutable generation 3."] }, truncated: false, cacheState: "miss" }; }
