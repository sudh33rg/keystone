...
describe("Risk Scoring", () => {
  ...
  it("should classify risk tiers correctly", () => {
    const highRiskFile: FileRiskData[] = [makeFileRiskData({ churn: 1, coupling: 1, coverage: 0 })];
    ...
    const lowRiskFile: FileRiskData[] = [makeFileRiskData({ churn: 0, coupling: 0, coverage: 1 })];
  ...
  it("should handle files with no risk", () => {
    const files: FileRiskData[] = [makeFileRiskData({ churn: 0, coupling: 0, coverage: 1 })];
